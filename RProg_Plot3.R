...
# which of these four sources have seen decreases in emissions from 1999??008 for Baltimore City? 
# Which have seen increases in emissions from 1999??008? 
# Use the ggplot2 plotting system to make a plot answer this question.

# Generate the graph in the same directory as the source code
png(filename='~/Exploratory_Data_Analysis/Assignment_2/Data_Plot3.png', width=800, height=500, units='px')
